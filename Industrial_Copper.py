...
try:
    ...
    if selected == "Home":
        ...
        with col2:
            st.image(Image.open("C://Users//Arun kumar L//Desktop//New folder//copper_image1.jpg"), width=500)
            st.image(Image.open("C://Users//Arun kumar L//Desktop//New folder//copper_image2.jpg"), width=500)
